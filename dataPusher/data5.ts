...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        short: {
            reasons: [
                "recent down trend from yesterday",
            ],
        ...
        long: {
            reasons: [
                "earnigns beat",
                "daily chart red to green"
            ],
            openDriveContinuation60Plan: { targets: tsmTarget, planConfigs: stock1Configs },
            levelBreakout: { entryPrice: 176.58, targets: tsmTarget, planConfigs: stock1Configs },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: tsmTarget, planConfigs: stock1Configs },
            firstNewHighPlan: { enableAutoTrigger: false, includeSecondNewHigh: true, targets: tsmTarget, planConfigs: stock1Configs },
            firstRetracementPlan: { targets: tsmTarget, planConfigs: stock1Configs },
        },
    },
    {
        symbol: 'WBD',
        ...
        autoFlip: false,
        vwapCorrection: { volumeSum: 0, tradingSum: 0 },
        marketCapInMillions: Constants.marketCaps.WBD,
        atr: {
            average: 0.27,
            mutiplier: 1.7,
            minimumMultipler: 1,
        ...
        summary: `
        gapped up 2 ATR on speculation news, and already big green bar from last 2 days, today should be profit taking.
        volume is low, so wait for 1 minute
        `,
        short: {
            reasons: [
                "profit taking",
                "gapped into resistance",
                "speculation news"
            ],
