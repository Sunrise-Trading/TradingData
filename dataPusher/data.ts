...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        analysis: {
            ...
            hourlyChart: "small bounce formed bear flag",
            premarketChart: "gap down bounce and vwap mixed",
            keyLevels: [16.7],
        },
        autoFlip: false,
        ...
        keyLevels: {
            momentumStartForLong: 16.7,
            momentumStartForShort: 16.7,
        },
        summary: `
        strong downtrend on the daily chart with recent 2 days making a small bounce and now gap lower. so it's a bear 
        flag setting up for a 2nd leg down. expect a big downtrend. wait for a small bounce and then short it.
        this is a good trade, so use 5 minute trailing stop as much as possible. that's big room to the downside.
        enable first 60 seconds, but for that, enable as scalp.
        `,
        contingencyPlan: `
        if open above vwap, wait for a breakout and then short green to red > 60.
        `,
        short: {
            reasons: [
                "strong downtrend on the daily chart",
                "debat not good"
            ],
