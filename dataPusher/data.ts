...
const alny: TradingPlans.PlanConfigs = {
    size: 0.2,
...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        marketCapInMillions: Constants.marketCaps.ALNY,
        atr: {
            average: 4.7,
            mutiplier: 2,
            minimumMultipler: 1,
        ...
        short: {
            profitTakingFade60Plan: { enableAutoTrigger: false, targets: R2Target, planConfigs: alny },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: R2Target, planConfigs: alny },
            firstNewHighPlan: { enableAutoTrigger: true, includeSecondNewHigh: true, targets: R2Target, planConfigs: alny },
            firstRetracementPlan: { targets: R2Target, planConfigs: alny },
            falseBreakoutPlan: { price: 0, targets: R2Target, planConfigs: alny },
        },
        long: {
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: R2Target, planConfigs: alny },
        },
    },
    {
        ...
        long: {
            ...
            falseBreakoutPlan: { price: 0, targets: R2Target, planConfigs: stock2Configs },
        },
    },
    {
        symbol: 'stock3',
