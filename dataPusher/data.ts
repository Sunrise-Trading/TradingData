...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        analysis: {
            ...
            weeklychart: "range",
            dailyChart: "down",
            hourlyChart: "range, false breakout",
            premarketChart: "above vwap ",
            keyLevels: [30.91],
            singleMomentumKeyLevel: 30.91,
            dualMomentumKeyLevels: [],
            profitTargetsForLong: { target1: 32.25, target2: 32.4, summary: "half at half, then hold rest into gap fill 32.4" },
            profitTargetsForShort: { target1: 29.71, target2: 29.38, summary: "first target is daily low 29.71, it's very close, if break lower, go below premarket low" },
        ...
        marketCapInMillions: Constants.marketCaps.X,
        atr: {
            average: 1.89,
            mutiplier: 1.4,
            minimumMultipler: 1,
        ...
        keyLevels: {
            momentumStartForLong: 29.71,
            momentumStartForShort: 31,
        },
        summary: `
        might be a range trading day between 29.71 to 31.
        `,
        setups: [],
        defaultConfigs: stock1Configs, defaultTargets: stock1Target,
        short: {
            reasons: [
                "gap down below premarket news rally low",
            ],
        ...
        long: {
            reasons: [
                "gap down to near daily support 29.71 and hold above vwap",
            ],
            levelMomentumPlan: { targets: stock1Target, planConfigs: stock1Configs },
            falseBreakoutPlan: { price: 0, targets: stock1Target, planConfigs: stock1Configs },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: stock1Target, planConfigs: stock1Configs },
    ...
    },
    {
        ...
        analysis: {
            ...
            premarketChart: "gap down bounce above vwap and then lost vwap",
            keyLevels: [186.86],
            singleMomentumKeyLevel: 186.86,
            dualMomentumKeyLevels: [],
            profitTargetsForLong: { target1: 193, target2: 199, summary: "first target is vwap, if hold above vwap, continue to 199-200" },
            profitTargetsForShort: { target1: 182, target2: 180, summary: "if below 182, potential is $20 move" },
        ...
        disableLongIfOpenBelow: 0,
        keyLevels: {
            momentumStartForLong: 186.86,
            momentumStartForShort: 186.86,
        },
        summary: `
        because it's a second day news, only trade around reaction low 186.86.
        `,
        setups: [],
        defaultConfigs: stock2Configs, defaultTargets: stock2Target,
        short: {
            reasons: [
                "gap down forming 2nd leg down",
            ],
    ...
    },
    {
        ...
        analysis: {
            ...
            gapSize: 0.7,
            weeklychart: "down range",
            dailyChart: "range",
            hourlyChart: "range",
            premarketChart: "above vwap",
            keyLevels: [13.79],
            singleMomentumKeyLevel: 13.79,
            dualMomentumKeyLevels: [],
            profitTargetsForLong: { target1: 14.4, target2: 14.72, summary: "14.4 is a heavy resistance, if breakout, re-entry for 14.72" },
            profitTargetsForShort: { target1: 13.5, target2: 13.31, summary: "potential give back all the rally from premarket" },
        ...
        disableLongIfOpenBelow: 0,
        keyLevels: {
            momentumStartForLong: 13.79,
            momentumStartForShort: 13.79,
        },
        summary: `
        use y-high as key level for trade. 
        `,
        setups: [],
    ...
    },
    {
        ...
        analysis: {
            ...
            keyLevels: [20, 19.35],
            singleMomentumKeyLevel: 20,
            dualMomentumKeyLevels: [],
            profitTargetsForLong: { target1: 20.71, target2: 22, summary: "if breakout premarket high, trailing stop" },
            profitTargetsForShort: { target1: 19.35, target2: 18.34, summary: "need to break below 19.35 to open more room to the downside" },
            vwapExtensionDistance: 2,
            choppyOpenRangeHigh: 0,
            choppyOpenRangeLow: 0,
        },
