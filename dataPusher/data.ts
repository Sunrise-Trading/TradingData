...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        analysis: {
            ...
            gapSize: 12,
            weeklychart: "uptrend, rallied stronger than SPY",
            dailyChart: "uptrend",
            hourlyChart: "consolidation",
            premarketChart: "was below, now above",
            keyLevels: [153.75, 153, 146],
        },
        autoFlip: false,
        ...
        summary: `
        earnings beat and firms upgrade the next morning. vwap is mixed, continue reevaluate near market open.
        and compare the move with SPY. due to vwap mix, it can go both up or down, but have big rooms.
        if not sure, wait for a defer entry. both direction can be big room, so use 50% trailing stop.
        if open above vwap, let it dip into vwap and long red to green > 60.
        ...
        short: {
            ...
            deferredBreakoutPlan: { targets: unlimitTargetForHalf, planConfigs: orclConfigs },
        },
        long: {
            reasons: [
                "earnings beat and firms upgrade the next morning.",
    ...
    },
    {
        ...
        analysis: {
            ...
            gapSize: 1,
            weeklychart: "middle of big trend after consolidation breakout",
            dailyChart: "rouding top",
            hourlyChart: "consolidation",
        ...
        summary: `
        only short the break down of yesterday low
        `,
        contingencyPlan: `
        if the stop is too wide, need to move stop to trailing stop
        `,
        short: {
            reasons: [
                "rouding top",
