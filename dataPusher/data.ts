...
const pepCOnfigs: TradingPlans.PlanConfigs = {
    size: defaultSize,
...
export const googleDocId = "1ZkX1N9711eCRryJmPS-2za4cahJb4HkgwQZvI8835S0";
export const stockSelections: string[] = [
    'PEP',
];
const pepLevel = 157.56;
const stock2Level = 1;
const stock3Level = 1;
const stock4Level = 1;
...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        marketCapInMillions: Constants.marketCaps.PEP,
        atr: {
            average: 2.44,
            mutiplier: 1.5,
            minimumMultipler: 1,
        ...
        defaultConfigs: pepCOnfigs, defaultTargets: stock1Target,
        short: {
            enabled: true,
            firstTargetToAdd: -1,
            finalTarget: "1 ATR: 50%",
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: pepCOnfigs },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: stock1Target, planConfigs: pepCOnfigs },
            firstNewHighPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: pepCOnfigs },
        },
        long: {
            enabled: true,
            firstTargetToAdd: 158.46,
            finalTarget: "1 ATR: 20%, 160: 30%",
            vwapScalpPlan: { threshold: 154.61, targets: stock1Target, planConfigs: pepCOnfigs },
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: pepCOnfigs },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: stock1Target, planConfigs: pepCOnfigs },
            firstNewHighPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: pepCOnfigs },
        }
