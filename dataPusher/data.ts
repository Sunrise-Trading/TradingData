...
const xpev: TradingPlans.PlanConfigs = {
    size: defaultSize,
...
export const topLevelPlans: Map<string, TradingPlans.TopLevelPlanItem> = new Map<string, TradingPlans.TopLevelPlanItem>([
    ['XPEV', {
        ...
        openAbove: { longStart: 0, shortStart: 120 },
        openBetween: { longStart: 0, shortStart: 120 },
        openBelow: { longStart: 0, shortStart: 0 }
    }], ['stock3', {
        openAbove: { longStart: 0, shortStart: 0 },
        openBetween: { longStart: 0, shortStart: 0 },
...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        analysis: {
            ...
            dailyRangeToBreakout: { high: 24, low: 22.5 },
            keyLevels: [24.72, 24.68],
            singleMomentumKeyLevel: { high: 24.72, low: 24.68 },
        ...
        setups: [],
        defaultConfigs: xpev, defaultTargets: stock1Target,
        short: {
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: xpev },
            falseBreakoutPlan: { price: 0, targets: stock1Target, planConfigs: xpev },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: stock1Target, planConfigs: xpev },
            firstNewHighPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: xpev },
            deferredBreakoutPlan: { targets: stock1Target, planConfigs: xpev },
        },
        long: {
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock1Target, planConfigs: xpev },
            falseBreakoutPlan: { price: 0, targets: stock1Target, planConfigs: xpev },
    ...
    },
    {
        ...
        analysis: {
            ...
            gapSize: 3,
            weeklychart: "", dailyChart: "", hourlyChart: "", premarketChart: "",// optional
            dailyRangeToBreakout: { high: 30, low: 28 },
            keyLevels: [31.35, 31.24],
            singleMomentumKeyLevel: { high: 31.35, low: 31.24 },
            dualMomentumKeyLevels: [],
            profitTargetsForLong: {
                targets: [], willBlowPastThoseLevels: -1, summary: `
                ` },
        ...
        autoFlip: false,
        vwapCorrection: { open: 0, volumeSum: 0, tradingSum: 0 },
        marketCapInMillions: Constants.marketCaps.LUV,
        atr: {
            average: 0.9,
            mutiplier: 1,
            minimumMultipler: 1,
        ...
        setups: [],
        defaultConfigs: luv, defaultTargets: stock2Target,
        short: {
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock2Target, planConfigs: luv },
            falseBreakoutPlan: { price: 0, targets: stock2Target, planConfigs: luv },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: stock2Target, planConfigs: luv },
            firstNewHighPlan: { enableAutoTrigger: false, targets: stock2Target, planConfigs: luv },
            deferredBreakoutPlan: { targets: stock2Target, planConfigs: luv },
        },
        long: {
            levelMomentumPlan: { enableAutoTrigger: false, targets: stock2Target, planConfigs: luv },
            falseBreakoutPlan: { price: 0, targets: stock2Target, planConfigs: luv },
