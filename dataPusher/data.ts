...
const srpt: TradingPlans.PlanConfigs = {
    size: 0.2,
...
export const stocksTradingPlans: TradingPlans.TradingPlans[] = [
    {
        ...
        short: {
            profitTakingFade60Plan: { enableAutoTrigger: false, targets: R2Target, planConfigs: srpt },
            falseBreakoutPlan: { price: 0, targets: R2Target, planConfigs: srpt },
            levelBreakout: { entryPrice: 159.89, targets: R2Target, planConfigs: srpt },
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: R2Target, planConfigs: srpt },
            firstNewHighPlan: { enableAutoTrigger: false, includeSecondNewHigh: true, targets: R2Target, planConfigs: srpt },
            firstRetracementPlan: { targets: R2Target, planConfigs: srpt },
        },
        long: {
            redtoGreenPlan: { strictMode: true, considerCurrentCandleAfterOneMinute: true, targets: R2Target, planConfigs: srpt },
            firstNewHighPlan: { enableAutoTrigger: false, includeSecondNewHigh: true, targets: R2Target, planConfigs: srpt },
